...
export const mockArticles: Article[] = [
  {
    ...
    title: '深入理解 Transformer 架构：从 Attention 到 GPT',
    excerpt:
...
GPT（Generative Pre-trained Transformer）使用了 Transformer 的解码器部分，通过自回归的方���生成文本。它的核心创新在于：
...
Transformer 架构的成功证明了 Attention 机制的强大。随着模型规模的不断增长和训练技术的改进，基于 Transformer 的模型将继续推动 AI 的边界。
    ...
    readingTime: 8,
    tags: ['Transformer', 'Deep Learning', 'NLP', 'GPT'],
  },
  {
    id: '2',
    slug: 'prompt-engineering-guide',
    title: 'Prompt Engineering 实战指南：让 LLM 输出更精准',
    excerpt:
...
Prompt Engineering 是一项需要不断实践的技能。随着你与 LLM 的交互经验增加，你会发展出更直觉的 Prompt 设计能力。
    ...
    readingTime: 6,
    tags: ['Prompt Engineering', 'LLM', 'RAG'],
  },
  {
    id: '3',
    slug: 'building-rag-system-with-langchain',
    title: '使用 LangChain 构建企业级 RAG 系统',
    excerpt:
...
构建一个高质量的 RAG 系统需要在文档处理、检索策略和 Prompt 设计三个层面持续优化。LangChain 提供了丰富的工具链，让开发者可以快速搭建原型并逐步迭代。
    ...
    readingTime: 10,
    tags: ['RAG', 'LangChain', 'LLM', 'Vector Database'],
  },
  {
    id: '4',
    slug: 'fine-tuning-llm-with-lora',
    title: 'LoRA 微调大模型：低成本定制你的专属 LLM',
    excerpt:
...
LoRA 让普通开发者也能在消费级 GPU 上微调大型语言模型。结合 QLoRA（量化 + LoRA），你甚至可以在单张 RTX 3090 上微调 7B 参数的模型。
  ...
  },
  {
    ...
    title: 'AI Agent 设计模式：从 ReAct 到多 Agent 协作',
    excerpt:
...
AI Agent 正在从实验室走向生产环境。选择合适的设计模式取决于任务的复杂度和可靠性要求。对于简单任务，ReAct 就够了；对于复杂工作流，Plan-and-Execute 或多 Agent 协作更为合适。
    ...
    readingTime: 9,
    tags: ['AI Agent', 'ReAct', 'Multi-Agent', 'LangChain'],
  },
];
